...
title: Shadow DOM
p: web/shadow-dom
date: 2019-12-02 14:14:24
categories: js
tags:
toc: false
---

there are times where an element requires complete encapsulation and we don’t want it to be affected by even global styles. 
...
<body>
  ...
  <script>
    ...
    // Next, we want to create the content to form our new shadow tree

    const link = document.createElement("a");
    link.href = shadowE1.querySelector("a").href;
    link.innerHTML = `<span aria-label="Twittter icon"></span>
                      ${shadowE1.querySelector("a").textContent}`;
